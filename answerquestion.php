...
<form name="reg" action="answerquestion.php?edit_form=<?php echo $editAsses ?>&id=<?php echo $id ?>";" method="post">
...
if (isset($_POST['Update'])) {
 ...
 // $patient_id = $_POST['i'];
  ...
  $query = "UPDATE pquestion set ansewers='$answer' where patient_id='$patient_id' and id='$id' ";
 mysql_query($query);
