...
<?php include('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="10" class="table table-striped table-bordered" id="example">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">Address</th>
                                     ...
                                     <th style="text-align:center;">HouseNumber</th>
                                    -->
                            ...
                            <tbody>
								...
								$result= mysql_query("select * from place order by ID" ) or die (mysql_error());
...
<td style="text-align:center; word-break:break-all; width:450px;"> <?php echo $row ['address']; ?></td>
								...
								<h3 id="myModalLabel"><b><?php echo $row['name']." ".$row['address']; ?></b></h3>
								</div>
								<div class="modal-body">
								<?php if($row['image'] != ""): ?>
								<img src="images/<?php echo $row['image']; ?>" style="width:1000px; border-radius:9px; border:5px solid #d0d0d0; margin-left: 63px; height:387px;">
								<?php else: ?>
